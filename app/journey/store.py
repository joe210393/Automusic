...
def account_journey_card(meta: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "has_full_final": bool(meta.get("final_full_file")),
...
def account_journey_detail(meta: Dict[str, Any]) -> Dict[str, Any]:
    ...
    card.update({
        ...
        "final_full_url": f"/api/journey/{jid}/audio/final-full" if meta.get("final_full_file") else None,
